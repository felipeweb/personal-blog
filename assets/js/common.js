window.addEventListener("load", function(){
  ...
  // Responsive Videos
  ======================= */
  reframe(".post__content iframe:not(.reframe-off), .page__content iframe:not(.reframe-off), .talk-content iframe:not(.reframe-off)");


  /* =======================
  // Zoom Image
  ======================= */
  const lightense = document.querySelector(".page img, .post img, .talk-content img"),
  imageLink = document.querySelectorAll(".page a img, .post a img, .talk-content a img");
  ...
  if (lightense) {
    Lightense(".page img:not(.no-lightense), .post img:not(.no-lightense), .talk-content img:not(.no-lightense)", {
    padding: 60,
    offset: 30
    });
  }
